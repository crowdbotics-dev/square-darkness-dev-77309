...
## Project Structure
    ...
    ├── square_darkness_dev_77309  # Django project configurations
...
1. Clone this repo and `cd square_darkness_dev_77309`
...
2. Clone this repo and `cd square_darkness_dev_77309`
